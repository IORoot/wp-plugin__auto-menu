...
function your_custom_menu_item($items, $args)
{
    ...
    if ($category_id == null || $category_id == false || $category_id == '') {
        return $items;
    }
...
function build_link($post_object, $count)
{
    ...
    if ($post_object->post_name == $current_post) {
        $current_class = ' menu-item-current ';
    }

    $relative_url = preg_replace('/.*\.com/', '', $post_object->guid);
